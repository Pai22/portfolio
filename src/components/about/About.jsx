...
import "./about.css"
import AboutImg from "../../assets/about22.jpg";
import Resume from "../../assets/Resume_Sarunporn.pdf";
import Info from './Info';

const About = () => {
  return (
    <section className="about__section" id="about" style={{marginTop:'5rem'}}>
        <h2 className="section__title">About Me</h2>
        <span className="section__subtitle" style={{textAlign:"center"}}>My introduction</span>
