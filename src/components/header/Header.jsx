...
const Header = () => {
  ...
  useEffect(() => {
    const handleHeader = () => {
        ...
        if (header) {  // ตรวจสอบว่ามี element หรือไม่
            if (window.scrollY >= 80) {  // ใช้ scrollY แทน headerY
    ...
    window.addEventListener('scroll', handleHeader);  // ใช้ 'scroll' แทน 'header'
  ...
  return (
    <header className='header'>
      <nav className='nav container'>
        <a href='index.html' className='nav__logo'>Pai</a>
