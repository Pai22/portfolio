...
const Data = () => {
  return (
    <div className="home__data">
        ...
        <p className="home__description">I'm a passionate web developer focused on creating seamless, 
          user-friendly experiences. Skilled in both front-end and back-end, 
          I combine creativity and functionality for robust, visually appealing solutions.
        </p>
